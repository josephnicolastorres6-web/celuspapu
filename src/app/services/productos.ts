...
// 1. Creamos el molde exacto de los productos de Celus Papu
...
export class ProductosService {
  ...
  // 2. Aquí está tu lista exacta de celulares (privada para protegerla)
  ...
  // 3. La función obligatoria que pide la guía para entregar los productos
  getProductos(): Prod[] {
